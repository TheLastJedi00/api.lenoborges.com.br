...
export class CreateWaitlistEntries1786650577257 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP TABLE IF EXISTS "waitlist_entries" CASCADE`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_90cae6cb55d051291054d7e8d1" ON "waitlist_entries" ("email") `);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_90cae6cb55d051291054d7e8d1"`);
